...
(() => {
  ...
  const PROGRAM_DAYS = [
    {
      ...
      items: [
        ...
        { time: "14:30 – 15:15", title: "Plénière — L’importance du plan de Dieu dans ma vie professionnelle: quand le métier devient une mission", tags: ["Plénière"] },
  ...
  const INTERVENANTS = [
    ...
    { "fullName": "Élie SINHOUNTO", "sector": "Banque, Finance, Assurance, Comptabilité, Gestion", "photo": "photos/Elie SINHOUNTO.jpeg", "role": "Consultant IT -  AMOA/ Gestion de projet" },
    { "fullName": "Gabriel ADETONAH", "sector": "Numérique/Informatique/Nouvelles technologies", "photo": "photos/Gabriel ADETONAH.jpeg", "role": "Chef de projet informatique" },
    { "fullName": "Regis MERCIER", "sector": "Numérique/Informatique/Nouvelles technologies", "photo": "photos/Régis MERCIER.jpeg", "role": "Chef de projet sur des outils digitaux" },
    { "fullName": "Moise TEKO", "sector": "BTP/Industries/Energie", "photo": "photos/Moise TEKO.jpeg", "role": "Chef de projet" },
    ...
    { "fullName": "Lewis SOMASSOU", "sector": "Musique/Théâtre/Comédie", "photo": "photos/Lewis SOMASSOU.jpeg", "role": "Artiste, compositeur, Interprète" },
    { "fullName": "Elisabeth KOFFI", "sector": "Fonction publique", "photo": "photos/Elisabeth KOFFI.jpeg", "role": "Chargée accompagnement  jeunes - FRANCE TRAVAIL " },
    { "fullName": "Jean-Yves MEFRE", "sector": "Banque, Finance, Assurance, Comptabilité, Gestion", "photo": "photos/Jean-Yves MEFRE.jpeg", "role": "Contrôleur de gestion" },
    { "fullName": "Marie-Emmanuel BRUNO", "sector": "Santé/Social", "photo": "photos/Marie-Emmanuel BRUNO.jpeg", "role": "Infirmière" },
    { "fullName": "Seynan ALOKPO", "sector": "Banque, Finance, Assurance, Comptabilité, Gestion", "photo": "photos/Seynan ALOKPO.jpeg", "role": "Expert-comptable" },
    { "fullName": "Donan TEKO", "sector": "Banque, Finance, Assurance, Comptabilité, Gestion", "photo": "photos/Donan TEKO.png", "role": "Responsable comptable/ Expertise comptable " },
    ...
    { "fullName": "Sylvia KADJA", "sector": "Enseignement / Recherche/ Formation", "photo": "photos/Sylvia KADJA.jpeg", "role": "Educatrice de jeunes enfants et fondatrice de 'Frères d'espoir'" },
    { "fullName": "Elia MEFRE", "sector": "Musique/Théâtre/Comédie", "photo": "photos/Elia Mefre.JPG", "role": "Actrice" },
    { "fullName": "Pelagie GAE", "sector": "Restauration/Traiteur", "photo": "photos/Pélagie GAE.jpg", "role": "Mamie Choco Traiteur / Auxiliaire de puéricuture " },
    ...
    { "fullName": "Wilfried GBONGBON", "sector": "BTP/Industries/Energie", "photo": "photos/Wilfried GBONGBON.jpeg", "role": "Chef de projet Génie Civil et Infrastructure de transport" },
    ...
    { "fullName": "Calixte OGAN", "sector": "Enseignement / Recherche/ Formation", "photo": "photos/Calixte OGAN.JPG", "role": "Chargé d’Accompagnement : Emploi, Insertion" },
    ...
    { "fullName": "Abiola PADONOU", "sector": "Enseignement / Recherche/ Formation", "photo": "photos/Abiola PADONOU.jpeg", "role": "Expert en Art Oratoire" },
